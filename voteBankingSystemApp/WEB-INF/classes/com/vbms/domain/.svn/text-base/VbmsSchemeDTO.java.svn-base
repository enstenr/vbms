...
// Generated Jan 19, 2012 9:22:51 AM by Hibernate Tools 3.4.0.CR1
 ...
 */
public class VbmsSchemeDTO  implements java.io.Serializable {
    ...
    public VbmsSchemeDTO() {
    }

	
    public VbmsSchemeDTO(int schemeid) {
        this.schemeid = schemeid;
    }
    public VbmsSchemeDTO(int schemeid, String schemename, String schemedescription, String startdate, String enddate, String agelowerlimit, String ageupperlimit, String gender, String area, String status) {
       this.schemeid = schemeid;
