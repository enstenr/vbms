 ...
 */
public class VbmsComplaint  implements java.io.Serializable {
	...
	public VbmsComplaint() {
    }

	
    public VbmsComplaint(String complaintid) {
        this.complaintid = complaintid;
    }
    public VbmsComplaint(String complaintid, String desc, String raisedby, String complaintby, String priority, String status) {
       this.complaintid = complaintid;
       this.desc = desc;
